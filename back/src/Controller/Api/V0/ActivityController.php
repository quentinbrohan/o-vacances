...
{
    /**
     * @Route("/api/v0/activities?user_id={id}", name="api_v0_activities_list", methods="GET")
     */
    ...
    /**
     * @Route("/api/v0/activities?user_id={id}", name="api_v0_activities_list", methods="POST")
     */
    public function new(ObjectNormalizer $normalizer, Request $request)
    {
        $activity = new Activity();
        //désactiver csrf car pas envoi de form mais envoi de json
